...
typedef struct
{
  ...
  char nick[40];		/* 暱稱 */
  time_t stamp;			/* hrs.080312: timestamp用來輔助已讀未讀判斷 */
  int money;			/* hrs.080312: 稿酬 */
  char pad;			/* hrs.080312: pad */
...
#define POST_COSIGN	0x00000004	/* 連署文章 */
#define POST_WIKI	0x00000008	/* post wiki:can be edited by anyone */
...
#define POST_LOCKED(xmode)  (xmode & POST_MARKED && xmode & POST_DONE)
#define POST_SPECIAL(xmode) (xmode & (POST_BOTTOM | POST_RESTRICT | POST_COSIGN | POST_WIKI) \
			     || POST_LOCKED(xmode))
