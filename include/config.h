...
#define BBSNAME		"叉滴小站"		/* 中文站名 */
#define BBSNAME2	"XDbbs"			/* 英文站名 */
#define SYSOPNICK	"站主"			/* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"	/* 身分認證函 token */
#define BBSALIAS	"叉滴本機"		/* 來自本機連線的故鄉 */

#define MYIPADDR	"163.20.173.53"		/* IP address */
#define MYHOSTNAME	"XDBBS.twbbs.org"	/* 網路地址 FQDN */
...
#define LOGINASGUEST		/* 提供guest參觀帳號 */
...
#define	LOG_BMW                 /* lkchu.981201: 叉滴記錄處理 */

#ifdef LOG_BMW
#define	RETAIN_BMW		/* itoc.021102: 叉滴存證 */
#endif
...
#define	BMW_COUNT		/* itoc.010312: 計算中了幾個叉滴 */

#define	BMW_DISPLAY		/* itoc.010313: 顯示之前的叉滴 */

#define BMW_ROBOT		/* hrs.080929: NPC自動回水球機器人 */
...
#define HAVE_FREECLOAK          /* hrs.091023: 免費隱形 */
...
#define	HAVE_LUCKYPOST		/* hrs.080128: LuckyPost,發文中獎,提升發文意願 */

#define HAVE_ALLPOST		/* hrs: 跨板式LOCAL新文章 */
...
#define HAVE_BBSNET		/* hrs.090107: 提供BBSNet雲遊四海服務 */

#ifdef HAVE_BBSNET
#   undef OPEN_BBSNET		/* hrs.090107: 開放BBSNet功能, 若定義:     */ 
#endif				/*	       則一般使用者也能使用，	   */ 
				/*	       否則只有站長才能使用本功能。*/
...
#define PRIVATE_KEY_PERIOD 1	/* 平均幾天換一次key，0 表示不換key，自動產生 */
#endif
...
#define MAXACTIVE	1024		/* 最多同時上站人數 */
...
#define BMW_EXPIRE	60		/* 叉滴處理時間(秒) */
#define BMW_PER_USER	5		/* 叉滴處理時間內，允許丟幾個叉滴 */
#define BMW_MAX		128		/* UCACHE 中 pool 上限 */
#define BMW_LOCAL_MAX	8		/* Ctrl+R 上下所能瀏覽之前叉滴個數 */

/* aloha.c 上站通知 */

#ifdef HAVE_ALOHA
#define ALOHA_MAX	256		/* 上站通知上限(人) */
#endif
...
#define	MAX_NOVALIDMAIL	10		/* 未認證 user 收信上限(封) */

#define MAX_BBSMAILSIZE     1024000       /* PERM_MBOX 容量上限(byte) */
#define MAX_VALIDMAILSIZE   512000        /* 認證 user 容量上限(byte) */
#define MAX_NOVALIDMAILSIZE 5120	  /* 未認證 user 容量上限(byte) */

/* hrs.080115: 新增檢查信箱大小
 * .todo:但是為什麼信箱無上限的人會被限制呢，觀察中 */
...
/* post.c Post Prefix 文章標題類別 */

#ifdef POST_PREFIX 
#define NUM_PREFIX 10
#endif
...
#define MAXSIGLINES	7		/* edit.c 簽名檔引入最大行數 */
#define MAXQUERYLINES	22		/* talk.c xchatd.c 顯示 Query/Plan 訊息最大行數 */
...
#define M3_USE_PMORE			/* hrs.080408: 使用 piaip's more */
#define HAVE_EXPAND_ESC_STAR		/* hrs: 自訂控制碼效果 */
#define USE_PFTERM			/* hrs.090924: 使用 piaip's flat terminal system */
                                        /* 由於程式已經為 pfterm 大作翻修，因
					 * 此請勿將此 undefine，避免出現問題。 */
#ifndef HAVE_GRAYOUT
#   define HAVE_GRAYOUT			/* 使用 grayout 特效 */
#endif
...
#define HAVE_BRD_EXPLAIN 

/* expire */
#define DEF_DAYS        730             /* 預設清除超過 730 天的文章 */
#define DEF_MAXP        7000            /* 預設清除超過 7000 篇的文章 */
#define DEF_MINP        3000            /* 預設低於 3000 篇的看板不砍文章 */
...
#define MAX_BBSDPORT	5	/* bbsd 要開幾個 port，隨 BBSD_PORT 而變 */
#define BBSD_PORT	{23, 2323, 2324, 2325, 2300}
/* bbsd   所用的 port (bbsd.c) */
