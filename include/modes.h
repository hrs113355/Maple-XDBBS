...
#define M_SYSTEM	20	/* → M_SYSTEM(含) 與 M_CHAT(含) 間不接受 talk request */
...
#define M_TALK		30	/* ← M_TALK(含) 與 M_IDLE(含) 間接 mateid */
#define M_CHAT		31	/* → M_BBTP(含) 與 M_CHAT(含) 間不接受 talk request */
#define M_PAGE		32
#define M_QUERY		33
#define M_IDLE		34	/* ← M_TALK(含) 與 M_IDLE(含) 間接 mateid */
...
#define PALTYPE_BPAL	2		/* 看板可見名單 */
#define PALTYPE_VOTE	3		/* 限制投票名單 */
#define PALTYPE_PBAD	4		/* 看板水桶名單 */
#define PALTYPE_CANSEE	5		/* 加密文章可見名單 */
...
#define XZ_RSS		(XO_ZONE + 14)  /* rss 待改 */

///////////////////////////////////////////////////////////
// 看板屬性狀態
///////////////////////////////////////////////////////////

#define	BMODE_OPEN	0	//公開板
#define	BMODE_HIDE	1	//隱藏板
#define BMODE_PAL	2	//好友板
#define	BMODE_SEAL	3	//封印板
