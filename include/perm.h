...
#define	PERM_CHANGEID	0x00000400
#define	PERM_ROBOT	0x00000800
#define	PERM_13		0x00001000
#define	PERM_14		0x00002000
#define	PERM_ART	0x00004000
...
#define PERM_GROUPOP	0x04000000      /* hrs:小組長 */
...
#define STR_PERM	"bctpjm#x--Ir---@PTCM--L*B#-RACBS"	/* itoc: 新增權限的時候別忘了改這裡啊 */
