...
{
  "  ", "●", 		/* Empty, Cover */
  ANSI_COLOR(1;33) "帥" ANSI_RESET,
  ANSI_COLOR(1;33) "仕" ANSI_RESET,
  ANSI_COLOR(1;33) "相" ANSI_RESET,
  ANSI_COLOR(1;33) "硨" ANSI_RESET,
  ANSI_COLOR(1;33) "傌" ANSI_RESET,
  ANSI_COLOR(1;33) "炮" ANSI_RESET,
  ANSI_COLOR(1;33) "兵" ANSI_RESET,
 
  ANSI_COLOR(1;37) "將" ANSI_RESET,
  ANSI_COLOR(1;37) "士" ANSI_RESET,
  ANSI_COLOR(1;37) "象" ANSI_RESET,
  ANSI_COLOR(1;37) "車" ANSI_RESET,
  ANSI_COLOR(1;37) "馬" ANSI_RESET,
  ANSI_COLOR(1;37) "包" ANSI_RESET,
  ANSI_COLOR(1;37) "卒" ANSI_RESET
};
